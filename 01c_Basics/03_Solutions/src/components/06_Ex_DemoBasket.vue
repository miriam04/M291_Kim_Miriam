<template>
  <div class="container">
    ...
    <div class="even-columns" v-for="(item,n) in products" :key="n">
...
export default {
  data() {
    return {
      ...
      totalCost: 0,
      products: [
        {title:"Socken", currency: "CHF", prize: 5.20},
        {title:"Pulli", currency: "CHF", prize: 66.80},
        {title:"Hosen", currency: "CHF", prize: 55.10},
      ],
    }
  },
  methods: {
